...
void frequency_range(double crop)
{
    ...
    tune_count = (int)((upper-lower)/bw_used);
...
/* for half of interleaved data */
{
    ...
    e = data[8];
    f = data[10];
    /*  a downsample should improve resolution, so don't fully
        shift
    */
